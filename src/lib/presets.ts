...
export const presets: Preset[] = [
  ...
  // Cross-Tech / Combo
  {
    ...
    description: "Complete desktop PDF editor. Rendering, creatie, annotaties en meertaligheid in Tauri",
    packages: ["tauri-2", "solidjs", "pdfjs", "pdf-lib", "fluent-i18n", "open-pdf-studio"],
    color: "#D32F2F",
    workflowType: "skill-package",
  },
  {
    id: "i18n-web",
    name: "i18n Web App",
    description: "Meertalige web applicatie met React, Vite en Mozilla Fluent vertaalsysteem",
    packages: ["react", "vite", "fluent-i18n"],
    color: "#7B1FA2",
    workflowType: "skill-package",
  },
  {
    id: "bim-validator",
    name: "BIM Validator",
    description: "IFC modellen valideren en controleren. Cross-technology integratie voor kwaliteitsborging",
    packages: ["blender-bonsai", "cross-tech-aec"],
    color: "#1565C0",
    workflowType: "skill-package",
  },
  {
    id: "ifc-web-platform",
    name: "IFC Web Platform",
    description: "Volledige BIM web stack. IFC laden, 3D weergave, Speckle samenwerking en Docker deployment",
    packages: ["thatopen", "threejs", "speckle", "docker"],
    color: "#00695C",
    workflowType: "skill-package",
  },
  {
    id: "erp-automation",
    name: "ERP + Automation",
    description: "ERPNext met geautomatiseerde workflows. Doctypes, API koppelingen en n8n triggers",
    packages: ["frappe", "n8n", "docker"],
    color: "#E65100",
    workflowType: "skill-package",
  },
  {
    ...
    description: "Nextcloud apps en integraties. PHP backend, Vue.js frontend, geautomatiseerde workflows",
    packages: ["nextcloud", "n8n", "docker"],
    color: "#0082C9",
    workflowType: "skill-package",
  },
  {
    id: "solidjs-app",
    name: "SolidJS App",
    description: "Reactieve web applicatie met SolidJS en Vite. Signals, stores en fine-grained reactivity",
    packages: ["solidjs", "vite"],
    color: "#4169E1",
    workflowType: "skill-package",
  },
