...
export const packages: SkillPackage[] = [
  // AEC/BIM
  {
    ...
    description: "73 deterministic Claude AI skills for Blender, Bonsai, IfcOpenShell and Sverchok. AEC Python development",
    category: "aec-bim",
    skillCount: 73,
  ...
  },
  {
    id: "react",
    name: "React",
    description: "24 deterministic Claude skills for React 18 and 19 development. Hooks, components, Server Components, testing",
    category: "web-dev",
    skillCount: 24,
  ...
  },
  {
    id: "vite",
    name: "Vite",
    description: "22 deterministic Claude AI skills for Vite 6, 7 and 8. Config, plugin API, HMR, SSR, library mode",
    category: "web-dev",
    skillCount: 22,
  ...
  // DevOps
  {
    id: "docker",
    name: "Docker",
    description: "Docker and Docker Compose skill package. Dockerfile best practices, multi-stage builds, Compose orchestration, container security",
    category: "devops",
    skillCount: 22,
